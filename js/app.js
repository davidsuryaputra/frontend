...
rentalkika.controller('LoginController', function ($rootScope, $scope, $http, $route, $window, $location, sessionService){
...
rentalkika.controller('RegisterController', function ($scope, $http, $location, fileUpload) {
	...
	$scope.upload = function () {
         ...
         var uploadUrl = "http://128.199.249.233:1337/parse/files/"+file.name;
...
rentalkika.controller('RegisterPartnerController', function ($scope, $http, $location, fileUpload) {
